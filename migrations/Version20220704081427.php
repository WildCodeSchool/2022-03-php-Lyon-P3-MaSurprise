 ...
 */
final class Version20220704081427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE baker (id INT AUTO_INCREMENT NOT NULL, created DATETIME NOT NULL, commercial_name VARCHAR(255) DEFAULT NULL, baker_type VARCHAR(255) NOT NULL, services VARCHAR(255) DEFAULT NULL, siret VARCHAR(255) DEFAULT NULL, diploma VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, facebook VARCHAR(255) DEFAULT NULL, instagram VARCHAR(255) DEFAULT NULL, update_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, buyer_id INT NOT NULL, billing_address_id INT NOT NULL, ordered_at DATETIME NOT NULL, order_status VARCHAR(50) NOT NULL, collect_date DATETIME DEFAULT NULL, total DOUBLE PRECISION NOT NULL, INDEX IDX_F52993986C755722 (buyer_id), INDEX IDX_F529939879D0C0E4 (billing_address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reset_password_request (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7CE748AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, baker_id INT DEFAULT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, phone VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649B1FA4C6F (baker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE order_line ADD seller_id INT NOT NULL, ADD delivery_address_id INT NOT NULL, ADD cake_name VARCHAR(255) NOT NULL, ADD cake_price DOUBLE PRECISION NOT NULL, ADD cake_size VARCHAR(255) NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_9CE58EE18DE820D9 ON order_line (seller_id)');
        $this->addSql('CREATE INDEX IDX_9CE58EE1EBF23851 ON order_line (delivery_address_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9CE58EE18DE820D9 ON order_line');
        $this->addSql('DROP INDEX IDX_9CE58EE1EBF23851 ON order_line');
        $this->addSql('ALTER TABLE order_line DROP seller_id, DROP delivery_address_id, DROP cake_name, DROP cake_price, DROP cake_size');
    }
}
